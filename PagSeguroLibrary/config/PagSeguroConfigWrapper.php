...
class PagSeguroConfigWrapper
{
     ...
     *
     */
    const PAGSEGURO_EMAIL = ENV_PAGSEGURO_EMAIL;
    /**
     *
     */
    const PAGSEGURO_TOKEN_PRODUCTION = ENV_PAGSEGURO_TOKEN_PRODUCTION;
    /**
     *
     */
    const PAGSEGURO_TOKEN_SANDBOX = ENV_PAGSEGURO_TOKEN_SANDBOX;
    /**
     *
     */
     ...
     *
     */
    const PAGSEGURO_APP_ID_SANDBOX = ENV_PAGSEGURO_APP_ID_SANDBOX;
    /**
     *
     */
     ...
     *
     */
    const PAGSEGURO_APP_KEY_SANDBOX = ENV_PAGSEGURO_APP_KEY_SANDBOX;
    /**
     * UTF-8, ISO-8859-1
     */
     ...
     */
    const PAGSEGURO_LOG_LOCATION = "../log/logs.txt";
